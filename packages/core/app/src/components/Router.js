...
import
{loginAction, logoutAction, LOGIN_URI, LOGOUT_URI, HOME_URI} from '../constants';
import {Session, SessionProvider} from '../context/session';

// -----------------------------------------------------------------------------


const ExtRoute = ({config, component, access, path, exact, Layout}) => {
//console.log('access',access['guest'])
  ...
  return (
    <Route path={path} exact={exact} render={(props) => {
      ...
      const pageProps = {router: {redirect}, session};
